...
describe RaidsController do
  ...
  # Raid. As you add validations to Raid, be sure to
  ...
  # RaidsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested raid as @raid" do
      raid = Raid.create! valid_attributes
      get :show, {:id => raid.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested raid as @raid" do
      raid = Raid.create! valid_attributes
      get :edit, {:id => raid.to_param}, valid_session
      assigns(:raid).should eq(raid)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Raid" do
        expect {
          post :create, {:raid => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved raid as @raid" do
        ...
        post :create, {:raid => {}}, valid_session
        assigns(:raid).should be_a_new(Raid)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested raid" do
        ...
        put :update, {:id => raid.to_param, :raid => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested raid as @raid" do
        raid = Raid.create! valid_attributes
        put :update, {:id => raid.to_param, :raid => valid_attributes}, valid_session
        assigns(:raid).should eq(raid)
      end
    ...
    describe "with invalid params" do
      it "assigns the raid as @raid" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Raid.any_instance.stub(:save).and_return(false)
        put :update, {:id => raid.to_param, :raid => {}}, valid_session
        assigns(:raid).should eq(raid)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested raid" do
      raid = Raid.create! valid_attributes
      expect {
        delete :destroy, {:id => raid.to_param}, valid_session
      }.to change(Raid, :count).by(-1)
    end
